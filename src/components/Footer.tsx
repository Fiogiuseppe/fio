  ...
  return (
    <footer className="border-t border-ink/10 bg-ink text-cream">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-3 md:px-10 md:py-20">
        ...
        <div>
          <TypographyLabel className="text-cream/40">Explore</TypographyLabel>
          <ul className={`${editorial.stack.block} space-y-2`}>
            {explore.map((item) => (
              <li key={item.href}>
                <Link href={item.href} className="no-underline hover:text-blue">
                  <TypographyMeta className="text-cream/80">{item.label}</TypographyMeta>
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div>
          <TypographyLabel className="text-cream/40">Connect</TypographyLabel>
          <ul className={`${editorial.stack.block} space-y-2`}>
            <li>
              <a href={`mailto:${SITE.email}`} className="no-underline hover:text-blue">
                <TypographyMeta className="text-cream/80">{SITE.email}</TypographyMeta>
              </a>
            </li>
            <li>
              <a
              ...
              >
                <TypographyMeta className="text-cream/80">Instagram</TypographyMeta>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-cream/10 px-6 py-6 text-center md:px-10">
        <TypographyMeta className="text-cream/35">
